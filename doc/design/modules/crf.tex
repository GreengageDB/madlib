...
Experiments show that the speed-up ration approaches the number of segments configured in the Greengage database.
...
In Greengage, Viterbi can be run in parallel over different subsets of the document on a multi-core machine.
