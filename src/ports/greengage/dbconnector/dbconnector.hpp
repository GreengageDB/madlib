...
#ifndef MADLIB_GREENGAGE_DBCONNECTOR_HPP
#define MADLIB_GREENGAGE_DBCONNECTOR_HPP
...
extern "C" {
    ...
    #include <executor/executor.h> // Greengage requires this for GetAttributeByNum()
...
#endif // defined(MADLIB_GREENGAGE_DBCONNECTOR_HPP)
